 ...
 */
public class SubServerHCMImpl extends UnicastRemoteObject implements SubServerInterface {

    private Vector v;
    private Vector closeC;
    private FrameSubServerHCM fs;
    private int dem = 1;

    public SubServerHCMImpl(FrameSubServerHCM f) throws RemoteException { // Hàm khởi tạo
        v = new Vector();
        closeC = new Vector();
        fs = f;
    }
    ...
    public boolean checkTime(String time) throws RemoteException { // Hàm kiểm tra thời gian
        ...
        try {
            ...
            Logger.getLogger(SubServerHCMImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
}
