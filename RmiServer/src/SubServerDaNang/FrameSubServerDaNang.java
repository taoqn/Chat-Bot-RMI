 ...
 */
public class FrameSubServerDaNang extends javax.swing.JFrame {

    private SubServerDaNangImpl ssdn;
     ...
     */
    public FrameSubServerDaNang() {
        initComponents();
        this.setTitle("Server Đà Nẵng");
    ...
    private void jButtonStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonStartActionPerformed
        try { //Hàm bắt đầu Server
            ...
            ssdn = new SubServerDaNangImpl(this);
            r.bind("rmi://localhost/DaNang", ssdn);
            JOptionPane.showMessageDialog(this, "Server Đà Nẵng đã sẵn sàng !.");
            jKhungHienThi.setText("Server Đà Nẵng đã sẵn sàng !");
            send("--------------------------------------------------------------------");
            setTimeBackup();
    ...
    private void jListClientValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jListClientValueChanged
        if (!evt.getValueIsAdjusting()) {  // Hàm chọn Client trong danh sách
            try {
                client = ssdn.getClientSubServer(jListClient.getSelectedIndex());
            } catch (RemoteException ex) {
                Logger.getLogger(FrameSubServerDaNang.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void jButtonCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCloseActionPerformed
        try { // Hàm xử lý đóng một client
            if (client != null) {
                ...
                ssdn.addClientCloseSubServer(client.getID() + "-" + TimePenalty);
                ssdn.disClientSubServer(client);
                client = null;
    ...
    private void jButtonSaoLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaoLuuActionPerformed
        try {// Hàm sao lưu bằng tay
            if (!jKhungHienThi.getText().toString().equals("")) {
                ...
                if (serverBK.BackupData(time, data, ssdn.getNameSubServer())) {
    ...
    public void setTimeBackup() {// Hàm setTimeBackup , Hàm Backup tự động
        Timer ti = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                jLabel1.setText(timeHT);// Hiện Thị Đồng Hồ Điện Tử
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameSubServerDaNang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameSubServerDaNang().setVisible(true);
            }
        });
    }
